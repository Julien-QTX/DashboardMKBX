...
<div class="fashion_section">
    ...
    <div class="category-carousel">
        <h1 class="fashion_taital"><?= $categoryInfo['libelle_categorie'] ?></h1>
        <div id="electronic_main_slider_<?= $category ?>" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <p class="price_text"><span
                                                style="color: #262626;"><?= $value['prix_unitaire'] ?>
                                                €</span></p>
            ...
            <a class="carousel-control-prev" href="#electronic_main_slider_<?= $category ?>" role="button"
                data-slide="prev" style="color:black">
                <i class='bx bxs-chevrons-left'></i>
                << Prev</a>
                    <a class="carousel-control-next" href="#electronic_main_slider_<?= $category ?>" role="button"
                        data-slide="next" style="color:black">
